      ...
      <div className="container">
        <div className="row">
          ...
          <div className="col-md-6 col-lg-3 mb-4 mb-lg-0">
            ...
            <a href="#" className="block-6">
              <img src="../../../assets/images/hero_1.jpg" alt="Image placeholder" className="img-fluid rounded mb-4"/>
        ...
        <div className="row pt-5 mt-5 text-center">
          <div className="col-md-12">
            ...
            Copyright &copy; All rights reserved | Lets Shop <i className="icon-heart" aria-hidden="true"></i>
